...
void pid_yaw_y_Init(void)
{
	...
	yaw_base1_pid.Derivative = 0.0282;    /* 微分常数 Derivative Const */    //0.106
...
void pid_ultra_1_Init(void)
{
	...
	ultra_base1_pid.Proportion =1.59;    /* 比例常数 Proportional Const */
	ultra_base1_pid.Integral = 0.0;      /* 积分常数 Integral Const */
	ultra_base1_pid.Derivative =0.356;    /* 微分常数 Derivative Const */ //1.24
...
void pid_ultra_2_Init(void)
{
	...
	ultra_base2_pid.Proportion =2.26;    /* 比例常数 Proportional Const */
	ultra_base2_pid.Integral = 0;      /* 积分常数 Integral Const */
	ultra_base2_pid.Derivative =25.5;    /* 微分常数 Derivative Const */ 
