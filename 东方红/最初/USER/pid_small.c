...
void pid_yaw_y_Init(void)
{
	...
	yaw_base1_pid.Derivative = 0.106;    //* 微分常数 Derivative Const
...
void pid_yaw_x_Init(void)
{
	...
	yaw_base2_pid.Proportion =0.65;    /* 比例常数 Proportional Const */ /// 0.6 /// 0.76
	yaw_base2_pid.Integral = 0;      /* 积分常数 Integral Const */
	yaw_base2_pid.Derivative = 0.88;    /* 微分常数 Derivative Const */  /// 0.73 /// 0.43
