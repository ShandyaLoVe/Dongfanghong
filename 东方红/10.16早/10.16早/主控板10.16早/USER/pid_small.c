...
void pid_yaw_y_Init(void)
{
	...
	yaw_base1_pid.Proportion =0.668;    /* 比例常数 Proportional Const */    //0.82
...
void pid_yaw_x_Init(void)
{
	...
	yaw_base2_pid.Proportion = 0.572;    //* 比例常数 Proportional Const */0.75    //0.6
	yaw_base2_pid.Integral = 0;    			/* 积分常数 Integral Const */
	yaw_base2_pid.Derivative = 0.0235;    //* 微分常数 Derivative Const */ 0.29    //0.73
...
void pid_ultra_2_Init(void)
{
	...
	ultra_base2_pid.Proportion = 1.95;    /* 比例常数 Proportional Const */
	ultra_base2_pid.Integral = 0;      /* 积分常数 Integral Const */
	ultra_base2_pid.Derivative = 0.7;    /* 微分常数 Derivative Const */ 
	
	ultra_base2_pid.Output_MAX=200;
	ultra_base2_pid.Output_MIN=-200;
	ultra_base2_pid.SUM_MAX=200;

	ultra_base2_pid.STEP=20; //200
	ultra_base2_pid.Anti_saturation=20;
